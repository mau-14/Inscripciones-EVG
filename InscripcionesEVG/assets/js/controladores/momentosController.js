class MomentosController {
    ...
    initializeEventListeners() {
        ...
        if (formMomento) {
            formMomento.addEventListener('submit', (e) => this.handleInsertarMomento(e));
        }

        // Formulario de editar momento
        const formEditarMomento = document.getElementById('formEditarMomento');
        if (formEditarMomento) {
            formEditarMomento.addEventListener('submit', (e) => this.handleEditarMomento(e));
        }
        ...
        if (btnConfirmarEliminar) {
            btnConfirmarEliminar.addEventListener('click', () => this.handleEliminarMomento());
        }
    ...
    async handleEliminarMomento() {
        ...
        try {
            const resultado = await this.model.eliminarMomento(this.idMomentoAEliminar);
            if (resultado.success) {
